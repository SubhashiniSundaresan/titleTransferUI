...
Run `ng serve` for a dev server. Navigate to `http://ec2-35-172-232-47.compute-1.amazonaws.com:4200/`. The app will automatically reload if you change any of the source files.
